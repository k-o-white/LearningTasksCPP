...
PROTOBUF_CONSTEXPR Record::Record(
  ...
  , /*decltype(_impl_.external_economy_)*/false} {}
...
const uint32_t TableStruct_record_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Record, _impl_.external_economy_),
  3,
  0,
  1,
  2,
...
class Record::_Internal {
 public:
  ...
  static void set_has_external_economy(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
...
Record::Record(const Record& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.external_economy_){}};
  ...
  ::memcpy(&_impl_.foundation_year_, &from._impl_.foundation_year_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.external_economy_) -
    reinterpret_cast<char*>(&_impl_.foundation_year_)) + sizeof(_impl_.external_economy_));
...
// @@protoc_insertion_point(message_clear_start:Record)
  ...
  if (cached_has_bits & 0x00000018u) {
    ::memset(&_impl_.foundation_year_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.external_economy_) -
        reinterpret_cast<char*>(&_impl_.foundation_year_)) + sizeof(_impl_.external_economy_));
  }
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          _Internal::set_has_external_economy(&has_bits);
          _impl_.external_economy_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Record::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(5, this->_internal_external_economy(), target);
  }
...
void Record::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.external_economy_ = from._impl_.external_economy_;
    }
...
void Record::InternalSwap(Record* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Record, _impl_.external_economy_)
      + sizeof(Record::_impl_.external_economy_)
      - PROTOBUF_FIELD_OFFSET(Record, _impl_.foundation_year_)>(
